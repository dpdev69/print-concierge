...
- V1.1: public discovery through 3DSEARCH, plus `import_public_candidate` for supported MakerWorld results; physical queueing still requires Bambuddy archive/imported trusted items.
